...
window.onload = e=>{
    ...
    snowflakes0 = createSnowflakes(number=100, min_speed=0, max_speed=0.25, min_alpha=0.0, max_alpha=1, min_radius=0.0, max_radius=2,ctxs[0])
    snowflakes1 = createSnowflakes(number=50, min_speed=0.2, max_speed=0.7, min_alpha=0.0, max_alpha=0.5, min_radius=1, max_radius=3,ctxs[1])
    snowflakes2 = createSnowflakes(number=50, min_speed=1, max_speed=3, min_alpha=0.5, max_alpha=1, min_radius=2, max_radius=4,ctxs[2])
    snowflakes3 = createSnowflakes(number=50, min_speed=1, max_speed=3, min_alpha=0.5, max_alpha=1, min_radius=3, max_radius=5,ctxs[3])
